/**
 *
 * Hold TSHIBA & get rewarded in BTT!
 * 
 * TorrentShiba (TSHIBA)
 * https://torrentshiba.com
 * https://t.me/TorrentShiba
 * https://twitter.com/TorrentShiba
 * https://www.reddit.com/r/TorrentShiba
 * https://instagram.com/torrentshiba
 * https://facebook.com/TorrentShiba
 * https://medium.com/@torrentshiba

  _______                        _    _____ _     _ _           
 |__   __|                      | |  / ____| |   (_) |          
    | | ___  _ __ _ __ ___ _ __ | |_| (___ | |__  _| |__   __ _ 
    | |/ _ \| '__| '__/ _ \ '_ \| __|\___ \| '_ \| | '_ \ / _` |
    | | (_) | |  | | |  __/ | | | |_ ____) | | | | | |_) | (_| |
    |_|\___/|_|  |_|  \___|_| |_|\__|_____/|_| |_|_|_.__/ \__,_|
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BTT = IBEP20(0x8595F9dA7b868b1822194fAEd312235E43007b49);
    ...
    //SETMEUP, approx time 45 to 50 mins
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = BTT.balanceOf(address(this));
        ...
        uint256 amount = BTT.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            BTT.transfer(shareholder, amount);
...
contract TorrentShiba is IBEP20, Auth {
    using SafeMath for uint256;

    address BTT = 0x8595F9dA7b868b1822194fAEd312235E43007b49;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "TorrentShiba";
    string constant _symbol = "TSHIBA";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0xDbFc84a422C7f7828700573EFeEbb390Fa1F33a8;
        marketingFeeReceiver = 0xa8b3a237068185A2964E840f1E7e02C292B4F6bA;
